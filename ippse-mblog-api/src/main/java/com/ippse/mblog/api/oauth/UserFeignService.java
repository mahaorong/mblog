...
public class UserFeignService {
	...
	public User follow(@PathVariable String followers) {
		User user = userFeignClient.follow(followers);
		return user;
	}

	public User removefollow(@PathVariable String followers) {
		User user = userFeignClient.removefollow(followers);
		return user;
	}

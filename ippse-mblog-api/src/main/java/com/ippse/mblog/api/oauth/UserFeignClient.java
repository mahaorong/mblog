...
@FeignClient(name = "ippse-user-api"/*, url="#{'${user-info-server}'}", fallback = UserFeignClientFallback.class*/)
public interface UserFeignClient {
	...
	public User follow(@PathVariable(value = "followers") String followers);
	
	//取消关注
	@RequestMapping(value ="/api/unfollow/{followers}", method = RequestMethod.POST)
	public User removefollow(@PathVariable(value = "followers") String followers);
	
	//更换头像
	@RequestMapping(value ="/api/u/update/userimage", method = RequestMethod.POST)
	public User updateimage(@RequestParam(value = "image") String image);
